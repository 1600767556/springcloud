...
import com.bjpowernode.springcloud.hystrix.MyHystrixCommand;
...
public class TestController {
    ...
    @RequestMapping("/test")
    public String test(){
        ResponseEntity<String> result=  restTemplate.getForEntity("http://06-eureka-client-hystrix-provider/test",String.class);
    ...
    public String test02(){
        ResponseEntity<String> result=  restTemplate.getForEntity("http://06-eureka-client-hystrix-provider/test02",String.class);
        String body=result.getBody();
        return "带有Hystrix的服务消费者-----"+body;
    }
...
//        System.out.println(str.length());
        ResponseEntity<String> result=  restTemplate.getForEntity("http://06-eureka-client-hystrix-provider/test03",String.class);
        String body=result.getBody();
